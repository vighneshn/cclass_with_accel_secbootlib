...
//
// On Tue Aug 11 13:43:55 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp7(CLK,
  ...
  reg [63 : 0] IF_ma_core_req_req_BITS_79_TO_68_37_EQ_0xB18_3_ETC___d232;
  wire [63 : 0] x__h8087, x__read_data__h8356;
  wire [30 : 0] bs__h4397;
  ...
  wire NOT_mhpmevent_0_1_EQ_0_2_3_AND_mhpmcounter_0_4_ETC___d23,
       ...
       mhpmevent_7_22_EQ_0_23_OR_NOT_mhpmcounter_7_24_ETC___d132,
       x__h3359,
       x__h3513,
       x__h3660,
       x__h3807,
  ...
  assign csr_op_arg_wget =
	     { ma_core_req_req[67:4],
	       IF_ma_core_req_req_BITS_79_TO_68_37_EQ_0xB18_3_ETC___d232,
	       ma_core_req_req[3:2] } ;
  always@(ma_core_req_req or x__h8087)
  begin
    case (ma_core_req_req[79:68])
      12'h338,
      12'h339,
      ...
      12'hB1E,
      12'hB1F:
	  csr_op_res_wget = x__h8087;
      default: csr_op_res_wget = x__h8087;
    endcase
  end
  ...
  assign bs__h4397 = wr_events_wget ;
  ...
  assign mhpmevent_6_07_EQ_0_08_OR_NOT_mhpmcounter_6_09_ETC___d117 =
	     ...
	     ma_mcountinhibit_mcountinhibit_val[6] ||
	     !ma_mhpminterrupten_v[6] ;
  assign mhpmevent_7_22_EQ_0_23_OR_NOT_mhpmcounter_7_24_ETC___d132 =
	     mhpmevent_7 == 64'd0 || mhpmcounter_7 != 64'd0 ||
	     ma_mcountinhibit_mcountinhibit_val[7] ||
	     !ma_mhpminterrupten_v[7] ;
  assign x__h3359 = bs__h4397[mhpmevent_0[4:0]] ;
  assign x__h3513 = bs__h4397[mhpmevent_1[4:0]] ;
  assign x__h3660 = bs__h4397[mhpmevent_2[4:0]] ;
  assign x__h3807 = bs__h4397[mhpmevent_3[4:0]] ;
  assign x__h3954 = bs__h4397[mhpmevent_4[4:0]] ;
  assign x__h4101 = bs__h4397[mhpmevent_5[4:0]] ;
  assign x__h4248 = bs__h4397[mhpmevent_6[4:0]] ;
  assign x__h4394 = bs__h4397[mhpmevent_7[4:0]] ;
  assign x__read_data__h8356 =
  ...
  begin
    case (ma_core_req_req[79:68])
	  ...
	  IF_ma_core_req_req_BITS_79_TO_68_37_EQ_0xB18_3_ETC___d232 =
	      mhpmcounter_7;
      default: IF_ma_core_req_req_BITS_79_TO_68_37_EQ_0xB18_3_ETC___d232 =
		   mhpmevent_7;
    endcase
  end
