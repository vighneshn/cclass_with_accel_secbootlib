...
//
// On Tue Aug 11 13:43:57 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkcsr(CLK,
  ...
  reg [1 : 0] CASE_csrfilemv_csrs_to_decode_BITS_198_TO_197_ETC__q1;
  wire [63 : 0] req_writedata__h1560;
  wire [1 : 0] x__h1588;
  ...
  assign mv_csrs_to_decode =
	     { CASE_csrfilemv_csrs_to_decode_BITS_198_TO_197_ETC__q1,
	       csrfile_mv_csrs_to_decode[196:0] } ;
  ...
  // remaining internal signals
  assign req_writedata__h1560 =
	     ma_debug_access_csrs_cmd[79] ?
	       ma_debug_access_csrs_cmd[64:1] :
	       64'd0 ;
  assign x__h1588 = ma_debug_access_csrs_cmd[79] ? 2'b01 : 2'b10 ;
  always@(csrfile_mv_csrs_to_decode)
  begin
    case (csrfile_mv_csrs_to_decode[198:197])
      2'd1, 2'd3:
	  CASE_csrfilemv_csrs_to_decode_BITS_198_TO_197_ETC__q1 =
	      csrfile_mv_csrs_to_decode[198:197];
      default: CASE_csrfilemv_csrs_to_decode_BITS_198_TO_197_ETC__q1 = 2'd0;
    endcase
  end
