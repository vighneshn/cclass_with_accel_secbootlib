...
//
// On Tue Aug 11 13:43:49 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp1(CLK,
  ...
  reg [63 : 0] MUX_rg_mtval_write_1__VAL_1;
  wire MUX_rg_mcause_write_1__SEL_1,
       ...
       MUX_rg_sepc_write_1__SEL_2,
       MUX_rg_sie_write_1__SEL_1,
       MUX_rg_sie_write_1__SEL_3,
       MUX_rg_stval_write_1__SEL_1;

  // remaining internal signals
  reg [63 : 0] IF_ma_core_req_req_BITS_79_TO_68_EQ_0x300_THEN_ETC___d195;
  reg [1 : 0] IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330;
  wire [63 : 0] new_value_data__h2839,
		new_value_data__h3156,
		new_value_data__h3183,
		new_value_data__h3209,
		new_value_data__h3260,
		new_value_data__h3400,
		new_value_data__h3427,
		new_value_data__h3453,
		new_value_data__h3504,
		x__h4498,
		x__h4760,
		x__h4914,
		x__h5370,
		...
		x__h8271,
		x__read_data__h8561;
  wire [62 : 0] IF_mav_upd_on_ret_prv_EQ_1_62_THEN_IF_wr_csr_m_ETC___d371,
		result__h9293,
		result__h9381;
  wire [61 : 0] IF_rg_mode_4_EQ_1_83_AND_mav_upd_on_trap_c_BIT_ETC___d386,
		IF_rg_smode_18_EQ_1_78_AND_mav_upd_on_trap_c_B_ETC___d382,
		y__h9747;
  wire [28 : 0] x__h3061;
  wire [18 : 0] lv_csr_mip__h2482;
  wire [16 : 0] lv_csr_mie__h2483;
  wire [11 : 0] x__h8962, x__h8992, x__h9931;
  wire [9 : 0] wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114;
  wire [7 : 0] rg_mtip_8_AND_rg_mtie_3_90_CONCAT_0_CONCAT_wr__ETC___d397;
  wire IF_csr_op_res_whas__24_THEN_csr_op_res_wget__2_ETC___d274,
       ma_core_req_req_BITS_79_TO_68_EQ_0x300_AND_IF__ETC___d247,
       r__h2842,
       wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d67,
       wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73,
       wr_csr_misa_wget__2_BIT_18_3_AND_rg_stip_9___d70,
       y__h3084,
       y__h8910;
  ...
  assign mv_csrs_to_decode =
	     { IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330,
	       lv_csr_mip__h2482,
	       lv_csr_mie__h2483,
	       rg_mideleg,
	       x__h8962,
  ...
  assign mav_upd_on_ret =
	     { IF_mav_upd_on_ret_prv_EQ_1_62_THEN_IF_wr_csr_m_ETC___d371,
	       1'b0 } ;
  ...
  assign mav_upd_on_trap =
		 ...
		 IF_rg_smode_18_EQ_1_78_AND_mav_upd_on_trap_c_B_ETC___d382 :
		 IF_rg_mode_4_EQ_1_83_AND_mav_upd_on_trap_c_BIT_ETC___d386,
	       2'b0 } ;
  ...
  // value method mv_resume_wfi
  assign mv_resume_wfi = x__h9931 != 12'd0 ;
  ...
  assign MUX_rg_sepc_write_1__SEL_2 =
	     EN_mav_upd_on_trap && mav_upd_on_trap_prv == 2'd1 ;
  ...
  always@(ma_core_req_req or x__h8271)
  begin
    case (ma_core_req_req[79:68])
      ...
      12'h343,
      12'h344:
	  MUX_rg_mtval_write_1__VAL_1 = x__h8271;
      default: MUX_rg_mtval_write_1__VAL_1 = x__h8271;
    endcase
  end

  // inlined wires
  always@(ma_core_req_req or
	  new_value_data__h3260 or
	  rg_seie or
	  rg_stie or
	  rg_ssie or
	  new_value_data__h3400 or
	  new_value_data__h3427 or
	  new_value_data__h3453 or
	  rg_stval or
	  wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114 or
	  new_value_data__h3504 or
	  new_value_data__h2839 or
	  rg_medeleg_u1 or
	  rg_medeleg_m2 or
	  rg_medeleg_l10 or
	  rg_mideleg or
	  ...
	  rg_mtie or
	  rg_msie or
	  new_value_data__h3156 or
	  new_value_data__h3183 or
	  new_value_data__h3209 or
	  rg_mtval or
	  x__h3061 or
	  rg_meip or
	  wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d67 or
	  rg_mtip or
	  wr_csr_misa_wget__2_BIT_18_3_AND_rg_stip_9___d70 or
	  rg_msip or wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73)
  begin
    case (ma_core_req_req[79:68])
      12'h100: rg_resp_to_core_wget = { 1'd1, new_value_data__h3260 };
      12'h104:
	  rg_resp_to_core_wget =
		...
		rg_ssie,
		1'd0 };
      12'h105: rg_resp_to_core_wget = { 1'd1, new_value_data__h3400 };
      12'h141: rg_resp_to_core_wget = { 1'd1, new_value_data__h3427 };
      12'h142: rg_resp_to_core_wget = { 1'd1, new_value_data__h3453 };
      12'h143: rg_resp_to_core_wget = { 1'd1, rg_stval };
      12'h144:
	  rg_resp_to_core_wget =
	      { 55'h40000000000000,
		wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114 };
      12'h180: rg_resp_to_core_wget = { 1'd1, new_value_data__h3504 };
      12'h300: rg_resp_to_core_wget = { 1'd1, new_value_data__h2839 };
      12'h302:
	  rg_resp_to_core_wget =
	      { 49'h1000000000000,
		rg_medeleg_u1,
	  ...
	  rg_resp_to_core_wget =
		...
		rg_ssie,
		1'd0 };
      12'h305: rg_resp_to_core_wget = { 1'd1, new_value_data__h3156 };
      12'h341: rg_resp_to_core_wget = { 1'd1, new_value_data__h3183 };
      12'h342: rg_resp_to_core_wget = { 1'd1, new_value_data__h3209 };
  ...
  assign csr_op_arg_wget =
	     { ma_core_req_req[67:4],
	       IF_ma_core_req_req_BITS_79_TO_68_EQ_0x300_THEN_ETC___d195,
	       ma_core_req_req[3:2] } ;
  ...
  assign rg_ext_seip_EN =
	     EN_ma_set_external_interrupt && wr_prv_wget == 2'd1 ;

  // register rg_fs
  assign rg_fs_D_IN = MUX_rg_mtval_write_1__VAL_1[14:13] ;
  assign rg_fs_EN = MUX_rg_sie_write_1__SEL_3 ;

  // register rg_mcause
  assign rg_mcause_D_IN =
	     MUX_rg_mcause_write_1__SEL_1 ?
	       MUX_rg_mtval_write_1__VAL_1[4:0] :
  ...
  // register rg_mcounterie
  assign rg_mcounterie_D_IN = MUX_rg_mtval_write_1__VAL_1[16] ;
  assign rg_mcounterie_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h304 ;

  // register rg_medeleg_l10
  assign rg_medeleg_l10_D_IN = MUX_rg_mtval_write_1__VAL_1[9:0] ;
  assign rg_medeleg_l10_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h302 ;

  // register rg_medeleg_m2
  assign rg_medeleg_m2_D_IN = MUX_rg_mtval_write_1__VAL_1[13:12] ;
  assign rg_medeleg_m2_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h302 ;

  // register rg_medeleg_u1
  assign rg_medeleg_u1_D_IN = MUX_rg_mtval_write_1__VAL_1[15] ;
  assign rg_medeleg_u1_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h302 ;

  // register rg_meie
  assign rg_meie_D_IN = MUX_rg_mtval_write_1__VAL_1[11] ;
  assign rg_meie_EN = EN_ma_core_req && ma_core_req_req[79:68] == 12'h304 ;

  // register rg_meip
  assign rg_meip_D_IN = ma_set_external_interrupt_ex_i ;
  assign rg_meip_EN = EN_ma_set_external_interrupt && wr_prv_wget == 2'd3 ;

  // register rg_mepc
  assign rg_mepc_D_IN =
	     MUX_rg_mepc_write_1__SEL_1 ?
	       MUX_rg_mtval_write_1__VAL_1[63:1] :
  ...
  assign rg_minterrupt_D_IN =
	     MUX_rg_mcause_write_1__SEL_1 ?
	       MUX_rg_mtval_write_1__VAL_1[63] :
	       mav_upd_on_trap_c[5] ;
  ...
  // register rg_mode
  assign rg_mode_D_IN = MUX_rg_mtval_write_1__VAL_1[1:0] ;
  assign rg_mode_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h305 &&
	     IF_csr_op_res_whas__24_THEN_csr_op_res_wget__2_ETC___d274 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_rg_mie_write_1__SEL_1:
	  rg_mpie_D_IN = MUX_rg_mtval_write_1__VAL_1[7];
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_rg_mpp_write_1__SEL_1:
	  rg_mpp_D_IN = MUX_rg_mtval_write_1__VAL_1[12:11];
  ...
  // register rg_mprv
  assign rg_mprv_D_IN = MUX_rg_mtval_write_1__VAL_1[17] ;
  assign rg_mprv_EN = MUX_rg_mie_write_1__SEL_1 ;

  // register rg_msie
  assign rg_msie_D_IN = MUX_rg_mtval_write_1__VAL_1[3] ;
  ...
  // register rg_mtie
  assign rg_mtie_D_IN = MUX_rg_mtval_write_1__VAL_1[7] ;
  ...
  // register rg_mtvec
  assign rg_mtvec_D_IN = { 32'd0, MUX_rg_mtval_write_1__VAL_1[31:2] } ;
  assign rg_mtvec_EN = EN_ma_core_req && ma_core_req_req[79:68] == 12'h305 ;

  // register rg_mxr
  assign rg_mxr_D_IN = MUX_rg_mtval_write_1__VAL_1[19] ;
  assign rg_mxr_EN = MUX_rg_sie_write_1__SEL_3 ;

  // register rg_satp_asid
  assign rg_satp_asid_D_IN = MUX_rg_mtval_write_1__VAL_1[52:44] ;
  assign rg_satp_asid_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h180 &&
	     (MUX_rg_mtval_write_1__VAL_1[63:60] == 4'd0 ||
	      MUX_rg_mtval_write_1__VAL_1[63:60] == 4'd8) ;

  // register rg_satp_mode
  assign rg_satp_mode_D_IN = MUX_rg_mtval_write_1__VAL_1[63:60] ;
  ...
  // register rg_satp_ppn
  assign rg_satp_ppn_D_IN = MUX_rg_mtval_write_1__VAL_1[43:0] ;
  ...
  // register rg_seie
  assign rg_seie_D_IN = MUX_rg_mtval_write_1__VAL_1[9] ;
  assign rg_seie_EN =
	     EN_ma_core_req &&
  ...
  always@(MUX_rg_sie_write_1__SEL_1 or
	  rg_spie or
	  MUX_rg_sepc_write_1__SEL_2 or
	  MUX_rg_sie_write_1__SEL_3 or MUX_rg_mtval_write_1__VAL_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_rg_sie_write_1__SEL_1: rg_sie_D_IN = rg_spie;
      MUX_rg_sepc_write_1__SEL_2: rg_sie_D_IN = 1'd0;
      MUX_rg_sie_write_1__SEL_3: rg_sie_D_IN = MUX_rg_mtval_write_1__VAL_1[1];
  ...
  // register rg_smode
  assign rg_smode_D_IN = MUX_rg_mtval_write_1__VAL_1[1:0] ;
  assign rg_smode_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h105 &&
	     IF_csr_op_res_whas__24_THEN_csr_op_res_wget__2_ETC___d274 ;

  // register rg_soft_seip
  assign rg_soft_seip_D_IN = MUX_rg_mtval_write_1__VAL_1[9] ;
  ...
  always@(MUX_rg_sie_write_1__SEL_1 or
	  MUX_rg_sepc_write_1__SEL_2 or
	  rg_sie or MUX_rg_sie_write_1__SEL_3 or MUX_rg_mtval_write_1__VAL_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_rg_sie_write_1__SEL_1: rg_spie_D_IN = 1'd1;
      MUX_rg_sepc_write_1__SEL_2: rg_spie_D_IN = rg_sie;
      MUX_rg_sie_write_1__SEL_3:
	  rg_spie_D_IN = MUX_rg_mtval_write_1__VAL_1[5];
  ...
  always@(MUX_rg_sie_write_1__SEL_1 or
	  MUX_rg_sepc_write_1__SEL_2 or
	  IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330 or
	  MUX_rg_sie_write_1__SEL_3 or MUX_rg_mtval_write_1__VAL_1)
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_rg_sepc_write_1__SEL_2:
	  rg_spp_D_IN =
	      IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330[0];
      MUX_rg_sie_write_1__SEL_3: rg_spp_D_IN = MUX_rg_mtval_write_1__VAL_1[8];
  ...
  // register rg_ssie
  assign rg_ssie_D_IN = MUX_rg_mtval_write_1__VAL_1[1] ;
  assign rg_ssie_EN =
	     EN_ma_core_req &&
	     (ma_core_req_req[79:68] == 12'h304 ||
	      ma_core_req_req[79:68] == 12'h104) ;
  ...
  // register rg_ssip
  assign rg_ssip_D_IN = MUX_rg_mtval_write_1__VAL_1[1] ;
  assign rg_ssip_EN =
	     EN_ma_core_req &&
  ...
  // register rg_stie
  assign rg_stie_D_IN = MUX_rg_mtval_write_1__VAL_1[5] ;
  assign rg_stie_EN =
	     EN_ma_core_req &&
	     (ma_core_req_req[79:68] == 12'h304 ||
	      ma_core_req_req[79:68] == 12'h104) ;
  ...
  // register rg_stip
  assign rg_stip_D_IN = MUX_rg_mtval_write_1__VAL_1[5] ;
  assign rg_stip_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h344 &&
	     ma_csr_misa_m[18] ;
  ...
  // register rg_stvec
  assign rg_stvec_D_IN = MUX_rg_mtval_write_1__VAL_1[63:2] ;
  assign rg_stvec_EN = EN_ma_core_req && ma_core_req_req[79:68] == 12'h105 ;

  // register rg_sum
  assign rg_sum_D_IN = MUX_rg_mtval_write_1__VAL_1[18] ;
  assign rg_sum_EN = MUX_rg_sie_write_1__SEL_3 ;

  // register rg_tsr
  assign rg_tsr_D_IN = MUX_rg_mtval_write_1__VAL_1[22] ;
  assign rg_tsr_EN = MUX_rg_sie_write_1__SEL_3 ;

  // register rg_tvm
  assign rg_tvm_D_IN = MUX_rg_mtval_write_1__VAL_1[20] ;
  assign rg_tvm_EN = MUX_rg_sie_write_1__SEL_3 ;

  // register rg_tw
  assign rg_tw_D_IN = MUX_rg_mtval_write_1__VAL_1[21] ;
  ...
  module_fn_csr_op instance_fn_csr_op_0(.fn_csr_op_writedata(csr_op_arg_wget[129:66]),
					...
					.fn_csr_op(x__h8271));
  assign IF_csr_op_res_whas__24_THEN_csr_op_res_wget__2_ETC___d274 =
	     MUX_rg_mtval_write_1__VAL_1[1:0] < 2'd2 ;
  assign IF_mav_upd_on_ret_prv_EQ_1_62_THEN_IF_wr_csr_m_ETC___d371 =
	     (mav_upd_on_ret_prv == 2'd1) ?
	       (ma_csr_misa_m[2] ? rg_sepc : result__h9293) :
	       (ma_csr_misa_m[2] ? rg_mepc : result__h9381) ;
  assign IF_rg_mode_4_EQ_1_83_AND_mav_upd_on_trap_c_BIT_ETC___d386 =
	     (rg_mode == 2'd1 && mav_upd_on_trap_c[5]) ?
	       rg_mtvec + y__h9747 :
	       rg_mtvec ;
  assign IF_rg_smode_18_EQ_1_78_AND_mav_upd_on_trap_c_B_ETC___d382 =
  ...
  assign lv_csr_mip__h2482 =
	     { ma_resume_int_resume_int_val & ma_core_halted_core_halted_val,
	       ma_halt_int_halt_int_val & y__h8910,
	       x__h3061 != 29'd0,
	       4'd0,
	       rg_meip,
	       1'd0,
	       ...
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73,
	       1'd0 } ;
  assign ma_core_req_req_BITS_79_TO_68_EQ_0x300_AND_IF__ETC___d247 =
	     ma_core_req_req[79:68] == 12'h300 &&
	     (MUX_rg_mtval_write_1__VAL_1[12:11] == 2'd3 ||
	      ma_csr_misa_m[18] &&
	      MUX_rg_mtval_write_1__VAL_1[12:11] == 2'd1 ||
	      ma_csr_misa_m[20] &&
	      MUX_rg_mtval_write_1__VAL_1[12:11] == 2'd0) ;
  assign new_value_data__h2839 = mv_csr_mstatus ;
  assign new_value_data__h3156 = { rg_mtvec, rg_mode } ;
  assign new_value_data__h3183 = { rg_mepc, 1'b0 } ;
  assign new_value_data__h3209 = { rg_minterrupt, 58'd0, rg_mcause } ;
  assign new_value_data__h3260 =
	     { r__h2842,
	       43'd8192,
	       rg_mxr,
	       rg_sum,
	       ...
	       rg_sie,
	       1'd0 } ;
  assign new_value_data__h3400 = { rg_stvec, rg_smode } ;
  assign new_value_data__h3427 = { rg_sepc, 1'b0 } ;
  assign new_value_data__h3453 = { rg_sinterrupt, 58'd0, rg_scause } ;
  assign new_value_data__h3504 =
	     { rg_satp_mode, 7'd0, rg_satp_asid, rg_satp_ppn } ;
  assign r__h2842 = rg_fs == 2'b11 ;
  assign result__h9293 = { rg_sepc[62:1], 1'd0 } ;
  assign result__h9381 = { rg_mepc[62:1], 1'd0 } ;
  assign rg_mtip_8_AND_rg_mtie_3_90_CONCAT_0_CONCAT_wr__ETC___d397 =
	     { rg_mtip & rg_mtie,
	       1'd0,
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_stip_9___d70 & rg_stie,
	       1'd0,
	       rg_msip & rg_msie,
	       1'd0,
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73 & rg_ssie,
	       1'd0 } ;
  assign wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114 =
	     { wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d67,
	       3'd0,
	       ...
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73,
	       1'd0 } ;
  assign wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d67 =
	     ma_csr_misa_m[18] & y__h3084 ;
  assign wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73 =
	     ma_csr_misa_m[18] & rg_ssip ;
  assign wr_csr_misa_wget__2_BIT_18_3_AND_rg_stip_9___d70 =
  ...
  assign x__h4498 =
	     { 48'd0,
	       ...
	       2'd0,
	       rg_medeleg_l10 } ;
  assign x__h4760 = { 52'd0, rg_mideleg } ;
  assign x__h4914 =
	     { 51'd0,
	       rg_mcounterie,
	       rg_meie,
  ...
  assign x__h5370 =
	     { 52'd0,
	       ...
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_ssip_2___d73,
	       1'd0 } ;
  assign x__h6994 = { 54'd0, rg_seie, 3'd0, rg_stie, 3'd0, rg_ssie, 1'd0 } ;
  assign x__h7275 =
	     { 54'd0,
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114 } ;
  assign x__h8962 =
	     { 2'd0,
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d114 } ;
  assign x__h8992 = { 2'd0, rg_seie, 3'd0, rg_stie, 3'd0, rg_ssie, 1'd0 } ;
  assign x__h9931 =
	     { rg_meip & rg_meie,
	       1'd0,
	       wr_csr_misa_wget__2_BIT_18_3_AND_rg_soft_seip__ETC___d67 &
	       rg_seie,
	       1'd0,
	       rg_mtip_8_AND_rg_mtie_3_90_CONCAT_0_CONCAT_wr__ETC___d397 } ;
  assign x__read_data__h8561 =
	     EN_ma_core_req ? rg_resp_to_core_wget[63:0] : 64'd0 ;
  assign y__h3084 = rg_soft_seip | rg_ext_seip ;
  assign y__h8910 = ~ma_core_halted_core_halted_val ;
  assign y__h9747 = { 57'd0, mav_upd_on_trap_c[4:0] } ;
  always@(ma_core_req_req or
	  new_value_data__h3504 or
	  new_value_data__h3260 or
	  x__h6994 or
	  ...
	  new_value_data__h3156 or
	  new_value_data__h3183 or
	  new_value_data__h3209 or rg_mtval or x__h5370)
  begin
    case (ma_core_req_req[79:68])
      12'h100:
	  IF_ma_core_req_req_BITS_79_TO_68_EQ_0x300_THEN_ETC___d195 =
	  ...
	  IF_ma_core_req_req_BITS_79_TO_68_EQ_0x300_THEN_ETC___d195 =
	      x__h5370;
      default: IF_ma_core_req_req_BITS_79_TO_68_EQ_0x300_THEN_ETC___d195 =
		   new_value_data__h3504;
    endcase
  end
  always@(wr_prv_wget)
  begin
    case (wr_prv_wget)
	  ...
	  IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330 =
	      wr_prv_wget;
      default: IF_wr_prv_wget__25_EQ_3_26_OR_wr_prv_wget__25__ETC___d330 =
		   2'd0;
    endcase
  end
