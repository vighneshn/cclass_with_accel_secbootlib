...
//
// On Tue Aug 11 13:44:14 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkcombo_mul(CLK,
  ...
  // value method mv_output
  assign mv_output = { mv_output_data__h1896, rg_valid_1, 5'd0 } ;
  ...
  // register rg_op1_0
  assign rg_op1_0_D_IN = { sign1__h1645 & ma_inputs_in1[63], ma_inputs_in1 } ;
  ...
  // register rg_op2_0
  assign rg_op2_0_D_IN = { sign2__h1646 & ma_inputs_in2[63], ma_inputs_in2 } ;
