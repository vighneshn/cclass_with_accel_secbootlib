...
module module_chk_interrupt(chk_interrupt_prv,
  ...
  wire [11 : 0] s_interrupts__h42,
		...
		y__h325;
  wire [5 : 0] x__h30;
  wire [4 : 0] IF_chk_interrupt_step_done_AND_NOT_chk_interru_ETC___d65;
  ...
  // remaining internal signals
  assign IF_chk_interrupt_step_done_AND_NOT_chk_interru_ETC___d65 =
	     (chk_interrupt_step_done && !chk_interrupt_debug[3]) ?
	       5'd20 :
  ...
  assign m_interrupts__h41 = x__h246 & y__h247 ;
  assign pending_interrupts__h43 = x__h109 | y__h110 ;
  assign s_interrupts__h42 = x__h322 & y__h323 ;
  assign x__h109 = x__h111 | y__h112 ;
  assign x__h111 =
	     (chk_interrupt_debug[4] && chk_interrupt_debug[0]) ?
	       debug_interrupts__h39 :
	       19'd0 ;
  assign x__h246 = x__h248 & y__h249 ;
  assign x__h248 = x__h250 & y__h251 ;
  assign x__h250 = chk_interrupt_mie & chk_interrupt_mip[16:0] ;
  assign x__h30 =
	     { 1'b1,
	       IF_chk_interrupt_step_done_AND_NOT_chk_interru_ETC___d65 } ;
  assign x__h322 = x__h324 & y__h325 ;
  assign x__h324 = x__h326 & chk_interrupt_mideleg ;
  assign x__h326 = chk_interrupt_sie & chk_interrupt_sip ;
  assign y__h110 =
  ...
  assign y__h112 =
	     (chk_interrupt_prv != 2'd3 || chk_interrupt_mstatus[3]) ?
	       ...
	       19'd0 ;
  assign y__h247 = {17{!chk_interrupt_debug[3]}} ;
  assign y__h249 = { 5'd31, ~chk_interrupt_mideleg } ;
  assign y__h251 =
	     {17{chk_interrupt_prv != 2'd3 || chk_interrupt_mstatus[3]}} ;
  assign y__h323 = {12{!chk_interrupt_debug[3]}} ;
  assign y__h325 =
	     {12{chk_interrupt_prv != 2'd3 && chk_interrupt_prv != 2'd1 ||
		 chk_interrupt_mstatus[1] && chk_interrupt_prv == 2'd1}} ;
