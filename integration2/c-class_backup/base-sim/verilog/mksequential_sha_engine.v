...
//
// On Tue Aug 11 13:42:12 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mksequential_sha_engine(CLK,
  ...
  FIFO2 #(.width(32'd256), .guarded(32'd1)) result_fifo(.RST(RST_N),
							.CLK(CLK),
  ...
  assign MUX_i_h_0_write_1__VAL_1 = tmp1__h1716 + tmp2__h1717 ;
  assign MUX_i_h_4_write_1__VAL_1 = i_h_3 + tmp1__h1716 ;
  assign MUX_pre_comp_write_1__VAL_1 = x__h1783 + y__h1784 ;
  assign MUX_pre_comp_write_1__VAL_2 =
	     x__h6048 + input_engine_pre_hash[31:0] ;
  assign MUX_w_15_write_1__VAL_1 = x__h4307 + y__h4308 ;

  // register i
  always@(EN_reset or MUX_i_write_1__SEL_2 or x__h4596 or EN_input_engine)
  case (1'b1)
    EN_reset: i_D_IN = 6'd0;
    MUX_i_write_1__SEL_2: i_D_IN = x__h4596;
  ...
  // submodule result_fifo
  assign result_fifo_D_IN = res__h4610 ;
  ...
  assign tmp1__h1716 = x__h2807 + pre_comp ;
  assign tmp2__h1717 = (x__h3055 ^ y__h3056) + (x__h3242 ^ y__h3243) ;
  assign x__h1783 = i_h_6 + w_1 ;
  assign x__h2807 = x__h2809 + y__h2810 ;
  assign x__h2809 = x__h2823 ^ y__h2824 ;
  assign x__h2823 = x__h2825 ^ y__h2826 ;
  assign x__h2825 = { i_h_4[5:0], i_h_4[31:6] } ;
  assign x__h3014 = i_h_4 & i_h_5 ;
  assign x__h3033 = ~i_h_4 ;
  assign x__h3055 = x__h3057 ^ y__h3058 ;
  assign x__h3057 = { i_h_0[1:0], i_h_0[31:2] } ;
  assign x__h3242 = x__h3244 ^ y__h3245 ;
  assign x__h3244 = i_h_0 & i_h_1 ;
  assign x__h4307 = x__h4309 + y__h4310 ;
  assign x__h4309 = w_0 + w_9 ;
  assign x__h4340 = x__h4342 ^ y__h4343 ;
  assign x__h4342 = { w_1[6:0], w_1[31:7] } ;
  assign x__h4472 = x__h4474 ^ y__h4475 ;
  assign x__h4474 = { w_14[16:0], w_14[31:17] } ;
  assign x__h4596 = i + 6'd1 ;
  assign x__h6048 = input_engine_input_val[511:480] + 32'h428A2F98 ;
  assign y__h2810 = x__h3014 ^ y__h3015 ;
  assign y__h2824 = { i_h_4[24:0], i_h_4[31:25] } ;
  assign y__h2826 = { i_h_4[10:0], i_h_4[31:11] } ;
  assign y__h3015 = x__h3033 & i_h_6 ;
  assign y__h3056 = { i_h_0[21:0], i_h_0[31:22] } ;
  assign y__h3058 = { i_h_0[12:0], i_h_0[31:13] } ;
  assign y__h3243 = i_h_1 & i_h_2 ;
  assign y__h3245 = i_h_0 & i_h_2 ;
  assign y__h4308 = x__h4472 ^ y__h4473 ;
  assign y__h4310 = x__h4340 ^ y__h4341 ;
  assign y__h4341 = { 3'd0, w_1[31:3] } ;
  assign y__h4343 = { w_1[17:0], w_1[31:18] } ;
  assign y__h4473 = { 10'd0, w_14[31:10] } ;
  assign y__h4475 = { w_14[18:0], w_14[31:19] } ;
  always@(x__h4596)
  begin
    case (x__h4596)
      6'd0: y__h1784 = 32'h428A2F98;
      6'd1: y__h1784 = 32'h71374491;
      6'd2: y__h1784 = 32'hB5C0FBCF;
      6'd3: y__h1784 = 32'hE9B5DBA5;
      6'd4: y__h1784 = 32'h3956C25B;
      6'd5: y__h1784 = 32'h59F111F1;
      6'd6: y__h1784 = 32'h923F82A4;
      6'd7: y__h1784 = 32'hAB1C5ED5;
      6'd8: y__h1784 = 32'hD807AA98;
      6'd9: y__h1784 = 32'h12835B01;
      6'd10: y__h1784 = 32'h243185BE;
      6'd11: y__h1784 = 32'h550C7DC3;
      6'd12: y__h1784 = 32'h72BE5D74;
      6'd13: y__h1784 = 32'h80DEB1FE;
      6'd14: y__h1784 = 32'h9BDC06A7;
      6'd15: y__h1784 = 32'hC19BF174;
      6'd16: y__h1784 = 32'hE49B69C1;
      6'd17: y__h1784 = 32'hEFBE4786;
      6'd18: y__h1784 = 32'h0FC19DC6;
      6'd19: y__h1784 = 32'h240CA1CC;
      6'd20: y__h1784 = 32'h2DE92C6F;
      6'd21: y__h1784 = 32'h4A7484AA;
      6'd22: y__h1784 = 32'h5CB0A9DC;
      6'd23: y__h1784 = 32'h76F988DA;
      6'd24: y__h1784 = 32'h983E5152;
      6'd25: y__h1784 = 32'hA831C66D;
      6'd26: y__h1784 = 32'hB00327C8;
      6'd27: y__h1784 = 32'hBF597FC7;
      6'd28: y__h1784 = 32'hC6E00BF3;
      6'd29: y__h1784 = 32'hD5A79147;
      6'd30: y__h1784 = 32'h06CA6351;
      6'd31: y__h1784 = 32'h14292967;
      6'd32: y__h1784 = 32'h27B70A85;
      6'd33: y__h1784 = 32'h2E1B2138;
      6'd34: y__h1784 = 32'h4D2C6DFC;
      6'd35: y__h1784 = 32'h53380D13;
      6'd36: y__h1784 = 32'h650A7354;
      6'd37: y__h1784 = 32'h766A0ABB;
      6'd38: y__h1784 = 32'h81C2C92E;
      6'd39: y__h1784 = 32'h92722C85;
      6'd40: y__h1784 = 32'hA2BFE8A1;
      6'd41: y__h1784 = 32'hA81A664B;
      6'd42: y__h1784 = 32'hC24B8B70;
      6'd43: y__h1784 = 32'hC76C51A3;
      6'd44: y__h1784 = 32'hD192E819;
      6'd45: y__h1784 = 32'hD6990624;
      6'd46: y__h1784 = 32'hF40E3585;
      6'd47: y__h1784 = 32'h106AA070;
      6'd48: y__h1784 = 32'h19A4C116;
      6'd49: y__h1784 = 32'h1E376C08;
      6'd50: y__h1784 = 32'h2748774C;
      6'd51: y__h1784 = 32'h34B0BCB5;
      6'd52: y__h1784 = 32'h391C0CB3;
      6'd53: y__h1784 = 32'h4ED8AA4A;
      6'd54: y__h1784 = 32'h5B9CCA4F;
      6'd55: y__h1784 = 32'h682E6FF3;
      6'd56: y__h1784 = 32'h748F82EE;
      6'd57: y__h1784 = 32'h78A5636F;
      6'd58: y__h1784 = 32'h84C87814;
      6'd59: y__h1784 = 32'h8CC70208;
      6'd60: y__h1784 = 32'h90BEFFFA;
      6'd61: y__h1784 = 32'hA4506CEB;
      6'd62: y__h1784 = 32'hBEF9A3F7;
      6'd63: y__h1784 = 32'hC67178F2;
    endcase
  end
  ...
  begin
    ...
    v__h1677 = v__h1683 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_hash)
	$display("SHA:%8h State:Hash Action:Hash cycle-%8h", v__h1677, i);
    if (RST_N != `BSV_RESET_VALUE)
