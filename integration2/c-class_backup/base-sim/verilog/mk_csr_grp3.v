...
//
// On Tue Aug 11 13:43:51 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_grp3(CLK,
  ...
  reg [1 : 0] MUX_rg_dcsr_prv_write_1__VAL_1;
  ...
  wire [63 : 0] new_value_data__h1794,
		new_value_data__h1843,
		x__h2120,
		x__h3174,
		x__h4061,
		x__h4580,
		x__read_data__h4214;
  wire [62 : 0] IF_NOT_mav_upd_on_debugger_c_ULT_49_08_09_AND__ETC___d219;
  wire [31 : 0] x__h1673, x__h1999;
  wire [30 : 0] r1__read__h2012;
  wire [29 : 0] r1__read__h1725, r1__read__h2014;
  wire [28 : 0] r1__read__h1727;
  wire [27 : 0] r1__read__h1729;
  wire [26 : 0] r1__read__h1731;
  wire [25 : 0] r1__read__h1733;
  wire [22 : 0] r1__read__h1735;
  wire [21 : 0] r1__read__h1737;
  wire [20 : 0] r1__read__h1739;
  wire [19 : 0] r1__read__h1741;
  wire [18 : 0] r1__read__h1743;
  wire [17 : 0] r1__read__h1745;
  wire [16 : 0] r1__read__h1747;
  ...
  // value method mv_csr_dcsr
  assign mv_csr_dcsr = { r1__read__h1725, rg_dcsr_prv } ;
  ...
  // actionvalue method mav_upd_on_debugger
  assign mav_upd_on_debugger = { rg_dcsr_prv, x__h4580 } ;
  ...
  begin
    case (wr_prv_wget)
      2'd1, 2'd3: MUX_rg_dcsr_prv_write_1__VAL_1 = wr_prv_wget;
      default: MUX_rg_dcsr_prv_write_1__VAL_1 = 2'd0;
    endcase
  end
  ...
  always@(ma_core_req_req or
	  ...
	  x__h1999 or
	  x__h1673 or
	  new_value_data__h1794 or
	  rg_csr_dscratch or
	  new_value_data__h1843 or
	  rg_csr_denable or
  ...
  begin
    case (ma_core_req_req[79:68])
      ...
      12'h320: rg_resp_to_core_wget = { 33'h100000000, x__h1999 };
      12'h7B0: rg_resp_to_core_wget = { 33'h100000000, x__h1673 };
      12'h7B1: rg_resp_to_core_wget = { 1'd1, new_value_data__h1794 };
      12'h7B2: rg_resp_to_core_wget = { 1'd1, rg_csr_dscratch };
      12'h7C0: rg_resp_to_core_wget = { 1'd1, new_value_data__h1843 };
      12'h7C1:
  ...
  assign csr_op_arg_wget =
	     { ma_core_req_req[67:4],
	       IF_ma_core_req_req_BITS_79_TO_68_EQ_0x7B0_THEN_ETC___d137,
	       ma_core_req_req[3:2] } ;
  always@(ma_core_req_req or x__h4061)
  begin
    case (ma_core_req_req[79:68])
      12'h306, 12'h7B0, 12'h7B1, 12'h7B2, 12'h7C0, 12'h7C1, 12'hB00, 12'hB02:
	  csr_op_res_wget = x__h4061;
      default: csr_op_res_wget = x__h4061;
    endcase
  end
  ...
  // register rg_csr_denable
  assign rg_csr_denable_D_IN = csr_op_res_wget[0] ;
  ...
  // register rg_csr_dtvec
  assign rg_csr_dtvec_D_IN = csr_op_res_wget[63:1] ;
  assign rg_csr_dtvec_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h7C0 ;

  // register rg_cy
  assign rg_cy_D_IN = csr_op_res_wget[0] ;
  ...
  // register rg_dcsr_ebreakm
  assign rg_dcsr_ebreakm_D_IN = csr_op_res_wget[15] ;
  assign rg_dcsr_ebreakm_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_ebreaks
  assign rg_dcsr_ebreaks_D_IN = csr_op_res_wget[13] ;
  assign rg_dcsr_ebreaks_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_ebreaku
  assign rg_dcsr_ebreaku_D_IN = csr_op_res_wget[12] ;
  assign rg_dcsr_ebreaku_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_mprven
  assign rg_dcsr_mprven_D_IN = csr_op_res_wget[4] ;
  ...
  assign rg_dcsr_prv_D_IN =
	     MUX_rg_csr_dpc_write_1__SEL_1 ?
	       MUX_rg_dcsr_prv_write_1__VAL_1 :
	       csr_op_res_wget[1:0] ;
  ...
  // register rg_dcsr_step
  assign rg_dcsr_step_D_IN = csr_op_res_wget[2] ;
  assign rg_dcsr_step_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_stepie
  assign rg_dcsr_stepie_D_IN = csr_op_res_wget[11] ;
  assign rg_dcsr_stepie_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_stopcount
  assign rg_dcsr_stopcount_D_IN = csr_op_res_wget[10] ;
  assign rg_dcsr_stopcount_EN = MUX_rg_dcsr_prv_write_1__SEL_2 ;

  // register rg_dcsr_stoptime
  assign rg_dcsr_stoptime_D_IN = csr_op_res_wget[9] ;
  ...
  // register rg_hpm_enabler
  assign rg_hpm_enabler_D_IN = csr_op_res_wget[31:3] ;
  assign rg_hpm_enabler_EN =
	     EN_ma_core_req && ma_core_req_req[79:68] == 12'h320 ;

  // register rg_ir
  assign rg_ir_D_IN = csr_op_res_wget[2] ;
  assign rg_ir_EN = EN_ma_core_req && ma_core_req_req[79:68] == 12'h320 ;

  // register rg_mcounteren
  assign rg_mcounteren_D_IN = csr_op_res_wget[31:0] ;
  ...
  // register rg_mhpminterrupten
  assign rg_mhpminterrupten_D_IN = csr_op_res_wget[31:0] ;
  ...
  module_fn_csr_op instance_fn_csr_op_0(.fn_csr_op_writedata(csr_op_arg_wget[129:66]),
					...
					.fn_csr_op(x__h4061));
  assign IF_NOT_mav_upd_on_debugger_c_ULT_49_08_09_AND__ETC___d219 =
	     (mav_upd_on_debugger_c >= 6'd49 &&
	      mav_upd_on_debugger_c <= 6'd53) ?
	       rg_csr_dtvec :
	       rg_csr_dpc ;
  assign new_value_data__h1794 = { rg_csr_dpc, 1'd0 } ;
  assign new_value_data__h1843 = { rg_csr_dtvec, 1'd0 } ;
  assign r1__read__h1725 = { r1__read__h1727, rg_dcsr_step } ;
  assign r1__read__h1727 = { r1__read__h1729, rg_dcsr_nmip } ;
  assign r1__read__h1729 = { r1__read__h1731, rg_dcsr_mprven } ;
  assign r1__read__h1731 = { r1__read__h1733, 1'd0 } ;
  assign r1__read__h1733 = { r1__read__h1735, rg_dcsr_cause } ;
  assign r1__read__h1735 = { r1__read__h1737, rg_dcsr_stoptime } ;
  assign r1__read__h1737 = { r1__read__h1739, rg_dcsr_stopcount } ;
  assign r1__read__h1739 = { r1__read__h1741, rg_dcsr_stepie } ;
  assign r1__read__h1741 = { r1__read__h1743, rg_dcsr_ebreaku } ;
  assign r1__read__h1743 = { r1__read__h1745, rg_dcsr_ebreaks } ;
  assign r1__read__h1745 = { r1__read__h1747, 1'd0 } ;
  assign r1__read__h1747 = { 16'd16384, rg_dcsr_ebreakm } ;
  assign r1__read__h2012 = { r1__read__h2014, 1'd0 } ;
  assign r1__read__h2014 = { rg_hpm_enabler, rg_ir } ;
  assign x__h1673 = { r1__read__h1725, rg_dcsr_prv } ;
  assign x__h1999 = { r1__read__h2012, rg_cy } ;
  assign x__h2120 = { 32'd0, x__h1673 } ;
  assign x__h3174 = { 63'd0, rg_csr_denable } ;
  assign x__h4580 =
	     { IF_NOT_mav_upd_on_debugger_c_ULT_49_08_09_AND__ETC___d219,
	       1'd0 } ;
  assign x__read_data__h4214 =
  ...
  always@(ma_core_req_req or rg_mhpminterrupten or rg_mcounteren or x__h1999)
  begin
    case (ma_core_req_req[79:68])
      12'h306:
	  CASE_ma_core_req_req_BITS_79_TO_68_0x306_rg_mc_ETC__q2 =
	      rg_mcounteren;
      12'h320:
	  CASE_ma_core_req_req_BITS_79_TO_68_0x306_rg_mc_ETC__q2 = x__h1999;
  ...
  always@(ma_core_req_req or
	  ...
	  new_value_data__h1794 or
	  rg_csr_dscratch or
	  new_value_data__h1843 or x__h3174 or rg_mcycle or rg_minstret)
  begin
    case (ma_core_req_req[79:68])
      12'h7B0:
	  IF_ma_core_req_req_BITS_79_TO_68_EQ_0x7B0_THEN_ETC___d137 =
