...
//
// On Tue Aug 11 13:44:20 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkriscv(resetpc,
  ...
  reg [2 : 0] CASE_IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2__ETC__q9,
	      ...
	      CASE_stage2tx_meta_to_stage3_enq_data_BITS_31_ETC__q2,
  ...
  reg [1 : 0] CASE_stage2mv_op1_BITS_1_TO_0_0_stage2mv_op1_ETC__q7,
	      ...
	      CASE_stage5mv_csrs_to_decode_BITS_198_TO_197__ETC__q6;
  wire [63 : 0] _theResult___snd_snd_snd__h11028, fl_pc__h10332;
  ...
  wire [4 : 0] _theResult___fst__h10961;
  wire NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d401,
       lv_count_dtlb_misses__h3058,
       lv_count_itlb_misses__h3057;
  ...
  // submodule pipe1
  FIFO2 #(.width(32'd122), .guarded(32'd1)) pipe1(.RST(RST_N),
						  .CLK(CLK),
						  .D_IN(pipe1_D_IN),
						  .ENQ(pipe1_ENQ),
						  .DEQ(pipe1_DEQ),
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf_1 =
	     stage0_RDY_ma_mispredict && stage3_RDY_mv_mispredict_snd &&
	     stage3_RDY_mv_mispredict_fst ;
  ...
  assign MUX_stage3_fwd_from_pipe4_first_1__VAL_1 =
	     { NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d401,
		 ...
		 { _theResult___fst__h10961,
		   _theResult___snd_snd_snd__h11028,
  ...
  assign pipe2_meta_D_IN =
	     { stage2_tx_meta_to_stage3_enq_data[102:32],
	       CASE_stage2tx_meta_to_stage3_enq_data_BITS_31_ETC__q2,
	       stage2_tx_meta_to_stage3_enq_data[28:0] } ;
  ...
  assign stage2_csrs_csr =
	     { CASE_stage5mv_csrs_to_decode_BITS_198_TO_197__ETC__q6,
	       stage5_mv_csrs_to_decode[196:0] } ;
  ...
  assign NOT_IF_pipe4_first__06_BITS_136_TO_135_07_EQ_2_ETC___d401 =
	     (rd__h10913 != 5'd0 ||
	      ((pipe4_D_OUT[136:135] == 2'd2) ?
		 pipe4_D_OUT[1] :
		 pipe4_D_OUT[136:135] != 2'd1)) &&
	     pipe4_D_OUT[0] == rg_wEpoch ;
  assign _theResult___fst__h10961 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[5:1] : 5'd0 ;
  assign _theResult___snd_snd_snd__h11028 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[69:6] : 64'd0 ;
  assign fl_pc__h10332 =
	     stage5_flush_fst ?
	       stage5_flush_snd_fst :
	       stage3_flush_from_exe_snd ;
  assign lv_count_dtlb_misses__h3058 =
	     EN_ma_dtlb_counters && ma_dtlb_counters_i ;
  assign lv_count_itlb_misses__h3057 =
  ...
  begin
    case (pipe4_D_OUT[136:135])
      2'd1: rd__h10913 = pipe4_D_OUT[5:1];
      2'd2: rd__h10913 = pipe4_D_OUT[11:7];
      default: rd__h10913 = 5'd0;
    endcase
  end
  always@(pipe2_meta_D_OUT)
  begin
    case (pipe2_meta_D_OUT[31:29])
      3'd0, 3'd1:
	  IF_pipe2_meta_notEmpty__16_THEN_IF_pipe2_meta__ETC___d134 =
	      pipe2_meta_D_OUT[31:29];
  ...
  begin
    case (stage2_tx_meta_to_stage3_enq_data[31:29])
      3'd0, 3'd1, 3'd2, 3'd3, 3'd4:
	  CASE_stage2tx_meta_to_stage3_enq_data_BITS_31_ETC__q2 =
	      stage2_tx_meta_to_stage3_enq_data[31:29];
      default: CASE_stage2tx_meta_to_stage3_enq_data_BITS_31_ETC__q2 = 3'd5;
    endcase
  end
  ...
  begin
    case (stage5_mv_csrs_to_decode[198:197])
      2'd1, 2'd3:
	  CASE_stage5mv_csrs_to_decode_BITS_198_TO_197__ETC__q6 =
	      stage5_mv_csrs_to_decode[198:197];
      default: CASE_stage5mv_csrs_to_decode_BITS_198_TO_197__ETC__q6 = 2'd0;
    endcase
  end
