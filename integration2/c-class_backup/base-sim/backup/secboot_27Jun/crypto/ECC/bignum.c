 ...
 * January 02, 2016
 *
 * Authors : Sravan Salaka, IIT Madras
 *****************************************************************************/
 ...
 *
 ******************************************************************************/
void BN_mod_add(bignum_t *r, bignum_t *a, bignum_t *b,bignum_t *m) 
{
	BN_add(r, a, b);
	if (BN_compare(r, m) >= 0)
		BN_sub(r, r, m);
 ...
 ******************************************************************************/
 void BN_mod_sub(bignum_t *r, bignum_t *a, bignum_t *b,bignum_t *m) 
{
	if (BN_compare(a, b) < 0)
	{
		BN_sub(r,b,a);
 ...
 */
static void BN_gcd(bignum_t *result, bignum_t * P, bignum_t *Q)
{
...
/***********************************************************************
 *
 *  Finding the inverse using extended euclidean method
 *
 ***********************************************************************/

void BN_inv_mod( bignum_t *X, bignum_t *A, bignum_t *N )
{
    int ret;
