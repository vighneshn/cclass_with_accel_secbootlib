...
void VmkTbSoc::_settle__TOP__36(VmkTbSoc__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->mkTbSoc__DOT__soc__DOT__x___05Fh889879 
        = ((0x8000U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
            ? ((0x4000U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                ? ((0x2000U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                    ? ((0x1000U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                        ? ((0x800U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                            ? ((0x400U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                                ? ((0x200U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                                    ? ((0x100U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                                        ? 0x7dU : 0xcU)
                                    : ((0x100U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
                                        ? 0x21U : 0x55U))
                                : ((0x200U & vlTOPp->mkTbSoc__DOT__soc__DOT__aes_aes_aes___05Fdr_col0mix)
