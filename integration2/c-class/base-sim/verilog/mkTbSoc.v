...
//
// On Mon Aug 17 18:03:37 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkTbSoc(CLK,
  ...
  wire [63 : 0] data__h13786;
  wire [3 : 0] x__h3592, x__h5233, x__h7025, x__h7051, x__read__h11192;
  ...
  assign rg_read_rx_1_whas =
	     WILL_FIRE_RL_check_if_character_present && x__read__h11192[3] ;
  ...
  // register delayed_actor
  assign delayed_actor_D_IN = TASK_get_frame___d245[4:0] ;
  ...
  // register rg_client_fd
  assign rg_client_fd_D_IN = b__h16163 ;
  assign rg_client_fd_EN =
	     WILL_FIRE_RL_rl_initial && b__h16163 != 32'hFFFFFFFF ;
  ...
  assign uart_uart_rRecvBitCount_D_IN =
	     uart_uart_pwRecvResetBitCount_whas ? 4'd0 : x__h5233 ;
  ...
  assign uart_uart_rRecvCellCount_D_IN =
	     uart_uart_pwRecvCellCountReset_whas ? 4'd0 : x__h3592 ;
  ...
  assign uart_uart_rXmitCellCount_D_IN =
	     uart_uart_pwXmitCellCountReset_whas ? 4'd0 : x__h7025 ;
  ...
  // register uart_uart_rXmitParity
  assign uart_uart_rXmitParity_D_IN = z__h8474 ^ uart_uart_fifoXmit_D_OUT[7] ;
  ...
  assign x__h3592 = uart_uart_rRecvCellCount + 4'd1 ;
  assign x__h5233 = uart_uart_rRecvBitCount + 4'd1 ;
  assign x__h7025 = uart_uart_rXmitCellCount + 4'd1 ;
  assign x__h7051 = uart_uart_rXmitBitCount + 4'd1 ;
  assign x__read__h11192 =
	     { uart_uart_fifoRecv_EMPTY_N,
	       uart_uart_fifoRecv_FULL_N,
	       uart_uart_fifoXmit_FULL_N,
  ...
  assign z__h8446 = z__h8439 ^ uart_uart_fifoXmit_D_OUT[2] ;
  assign z__h8453 = z__h8446 ^ uart_uart_fifoXmit_D_OUT[3] ;
  assign z__h8460 = z__h8453 ^ uart_uart_fifoXmit_D_OUT[4] ;
  assign z__h8467 = z__h8460 ^ uart_uart_fifoXmit_D_OUT[5] ;
  assign z__h8474 = z__h8467 ^ uart_uart_fifoXmit_D_OUT[6] ;
  ...
  begin
	...
	begin
	  TASK_testplusargs___d215 = $test$plusargs("rtldump");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_write_dump_file && TASK_testplusargs___d215)
	$fwrite(dump,
		CASE_socio_dump_get_BITS_167_TO_166_1_socio__ETC__q1,
		" 0x%16h",
	...
	begin
	  b__h16163 = $imported_init_rbb_jtag(1'd0);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_initial)
	begin
	  TASK_get_frame___d245 = $imported_get_frame(rg_client_fd);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_initial && TASK_get_frame___d245[5]) $display("OpenOcd Exit");
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_initial && TASK_get_frame___d245[5]) $finish(32'd1);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_write_received_character)
	$fwrite(dump1, "%c", data__h13786);
  end
  // synopsys translate_on
endmodule  // mkTbSoc
