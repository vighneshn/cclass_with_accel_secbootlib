...
//
// On Tue Jun 16 01:06:17 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkicache(CLK,
  ...
  wire [511 : 0] IF_SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_vali_ETC___d250,
		 ...
		 _theResult_____1__h33563,
		 _theResult_____2_fst__h27381,
		 hitline__h25087,
		 x__h26368,
		 x__h28284,
		 x__h33630,
		 ...
		 y__h33631,
		 y__h96728;
  wire [31 : 0] _theResult_____2_snd__h23481,
		v__h23172,
		we__h33736,
		we__h33765,
		we__h33794,
		...
		word__h23326,
		x_address__h29707,
		y_avValue_snd__h23306,
		y_avValue_snd__h23321;
  wire [15 : 0] _theResult_____2__h30202,
		temp__h30282,
		w__h30307,
		w__h30366,
		x__h30311;
  wire [8 : 0] block_offset__h24027;
  wire [5 : 0] v_cause__h23625;
  wire [3 : 0] IF_SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_vali_ETC___d220,
	       ...
	       _theResult_____1_fst__h25500,
	       _theResult_____1_fst__h25625,
	       _theResult_____1_fst__h25750,
	       _theResult_____2_snd_snd_fst__h27970,
	       _theResult_____2_snd_snd_fst__h27987,
	       _theResult_____2_snd_snd_fst__h28004,
	       fbhit__h27329,
	       hit__h25086,
	       x__h110777,
	       x__h30459;
  ...
  FIFO2 #(.width(32'd68), .guarded(32'd1)) ff_core_request(.RST(RST_N),
							   .CLK(CLK),
  ...
  FIFO2 #(.width(32'd2), .guarded(32'd1)) ff_fb_fillindex(.RST(RST_N),
							  .CLK(CLK),
  ...
  assign wr_ram_response_wget =
	     (hit__h25086 != 4'd0 && cache_enable_c) ? 2'd0 : 2'd1 ;
  ...
  assign rg_fbfillenable_D_IN =
	     { _theResult_____2__h30202[13:0],
	       _theResult_____2__h30202[15:14] } ;
  ...
  // submodule ff_read_mem_request
  assign ff_read_mem_request_D_IN = { x_address__h29707, 11'd59 } ;
  ...
  assign SEL_ARR_fb_addr_0_16_fb_addr_1_10_fb_addr_2_04_ETC___d1093 =
	     SEL_ARR_fb_addr_0_16_fb_addr_1_10_fb_addr_2_04_ETC___d1090[11:6] ==
	     rg_latest_index ;
  assign _theResult_____1__h33563 =
	     { we__h33736,
	       we__h33765,
	       we__h33794,
	       we__h33823,
  ...
  assign fb_valid_0_9_OR_fb_valid_1_0_OR_fb_valid_2_1_O_ETC___d1103 =
	     fb_valid_0 || fb_valid_1 || fb_valid_2 || fb_valid_3 ;
  assign fbhit__h27329 =
	     (fb_addr_3[31:6] == ff_from_tlb_rv_port1__read[38:13] &&
	      fb_valid_3) ?
	       _theResult_____2_snd_snd_fst__h27970 :
	       IF_fb_addr_2_04_BITS_31_TO_6_05_EQ_ff_from_tlb_ETC___d337 ;
  assign ff_from_tlb_rv_port1__read__5_BITS_38_TO_7_74__ETC___d429 =
	     ff_from_tlb_rv_port1__read[38:7] < 32'h01000000 ;
  assign hit__h25086 =
	     (SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_valid_2_ETC___d202[3] &&
	      ...
	      tag_arr_3_ram_single_0_douta) ?
	       _theResult_____1_fst__h25500 :
	       IF_SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_vali_ETC___d228 ;
  assign hitline__h25087 =
	     (SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_valid_2_ETC___d202[3] &&
	      ff_from_tlb_rv_port1__read[38:19] ==
	      tag_arr_3_ram_single_0_douta) ?
	       data_arr_3_ram_single_0_douta :
	       IF_SEL_ARR_rg_valid_0_36_rg_valid_1_37_rg_vali_ETC___d252 ;
  assign temp__h30282 = w__h30307 | x__h30311 ;
  assign v__h101637 =
	     (valid__h101640 == 4'd15) ?
	       SEL_ARR_replacement_v_count_0_122_replacement__ETC___d1187 :
	       (valid__h101640[3] ?
		  (valid__h101640[2] ?
		     (valid__h101640[1] ? 2'd0 : 2'd1) :
		     2'd2) :
		  2'd3) ;
  assign v__h23172 = wr_ram_hitword_whas ? x__h26368[31:0] : 32'd0 ;
  assign v_cause__h23625 =
	     (!ff_from_tlb_rv_port1__read[6] &&
	      IF_wr_ram_response_whas__2_THEN_wr_ram_respons_ETC___d64 !=
	      2'd0 &&
	      IF_IF_wr_fb_response_whas__6_THEN_wr_fb_respon_ETC___d112) ?
  ...
  assign w__h30307 = w__h30366 | w__h30366 ;
  assign w__h30366 =
	     16'd1 <<
	     SEL_ARR_fb_addr_0_16_fb_addr_1_10_fb_addr_2_04_ETC___d479[5:2] ;
  assign we__h33736 = {32{_theResult_____2__h30202[15]}} ;
  assign we__h33765 = {32{_theResult_____2__h30202[14]}} ;
  assign we__h33794 = {32{_theResult_____2__h30202[13]}} ;
  assign we__h33823 = {32{_theResult_____2__h30202[12]}} ;
  assign we__h33852 = {32{_theResult_____2__h30202[11]}} ;
  assign we__h33881 = {32{_theResult_____2__h30202[10]}} ;
  assign we__h33910 = {32{_theResult_____2__h30202[9]}} ;
  assign we__h33939 = {32{_theResult_____2__h30202[8]}} ;
  assign we__h33968 = {32{_theResult_____2__h30202[7]}} ;
  assign we__h33997 = {32{_theResult_____2__h30202[6]}} ;
  assign we__h34026 = {32{_theResult_____2__h30202[5]}} ;
  assign we__h34055 = {32{_theResult_____2__h30202[4]}} ;
  assign we__h34084 = {32{_theResult_____2__h30202[3]}} ;
  assign we__h34113 = {32{_theResult_____2__h30202[2]}} ;
  assign we__h34142 = {32{_theResult_____2__h30202[1]}} ;
  assign we__h34171 = {32{_theResult_____2__h30202[0]}} ;
  assign word___1__h23482 =
	     ff_nc_read_response_rv_port1__read[34] ?
  ...
  assign word__h23326 =
	     (IF_wr_ram_response_whas__2_THEN_wr_ram_respons_ETC___d64 ==
	      2'd0) ?
	       v__h23172 :
	       y_avValue_snd__h23321 ;
  assign x__h110777 = 4'd1 << v__h101637 ;
  assign x__h26368 = hitline__h25087 >> block_offset__h24027 ;
  assign x__h27130 = x__h27142 + y__h27143 ;
  assign x__h27142 = x__h27154 + y__h27155 ;
  assign x__h27154 = { 2'd0, hit__h25086[3] } ;
  assign x__h28284 = _theResult_____2_fst__h27381 >> block_offset__h24027 ;
  assign x__h28893 = x__h28905 + y__h28906 ;
  assign x__h28905 = x__h28917 + y__h28918 ;
  assign x__h28917 = { 2'd0, fbhit__h27329[3] } ;
  assign x__h30311 = 16'd1 << x__h30459 ;
  assign x__h30459 =
	     SEL_ARR_fb_addr_0_16_fb_addr_1_10_fb_addr_2_04_ETC___d479[5:2] +
	     4'd1 ;
  assign x__h33630 = x__h33632 & y__h33633 ;
  assign x__h33632 =
	     { ~_theResult_____2__h30202[15],
	       ~_theResult_____2__h30202[15],
	       ~_theResult_____2__h30202[15],
	       ~_theResult_____2__h30202[15],
	       ~_theResult_____2__h30202[15],
	       ...
	       ~_theResult_____2__h30202[0],
	       ~_theResult_____2__h30202[0] } ;
  assign x_address__h29707 = { ff_from_tlb_rv_port1__read[38:10], 3'd0 } ;
  assign y__h27131 = { 2'd0, hit__h25086[0] } ;
  assign y__h27143 = { 2'd0, hit__h25086[1] } ;
  assign y__h27155 = { 2'd0, hit__h25086[2] } ;
  assign y__h28894 = { 2'd0, fbhit__h27329[0] } ;
  assign y__h28906 = { 2'd0, fbhit__h27329[1] } ;
  assign y__h28918 = { 2'd0, fbhit__h27329[2] } ;
  assign y__h33631 = _theResult_____1__h33563 & y__h96728 ;
  assign y__h96728 = {8{ff_read_mem_response_rv_port1__read[65:2]}} ;
  assign y_avValue_snd__h23306 =
	     CAN_FIRE_RL_check_fb_for_corerequest ? x__h28284[31:0] : 32'd0 ;
  assign y_avValue_snd__h23321 =
	     (IF_wr_fb_response_whas__6_THEN_wr_fb_response__ETC___d68 ==
	      2'd0) ?
	       y_avValue_snd__h23306 :
	       _theResult_____2_snd__h23481 ;
  always@(ff_fb_fillindex_D_OUT or
	  fb_dataline_0 or fb_dataline_1 or fb_dataline_2 or fb_dataline_3)
  begin
    case (ff_fb_fillindex_D_OUT)
      2'd0: y__h33633 = fb_dataline_0;
      2'd1: y__h33633 = fb_dataline_1;
      2'd2: y__h33633 = fb_dataline_2;
      2'd3: y__h33633 = fb_dataline_3;
    endcase
  end
  always@(rg_fbwriteback or
  ...
  begin
    case (rg_fbwriteback)
      2'd0: x__h101564 = fb_enables_0;
      2'd1: x__h101564 = fb_enables_1;
      2'd2: x__h101564 = fb_enables_2;
      2'd3: x__h101564 = fb_enables_3;
    endcase
  end
  ...
  begin
    case (SEL_ARR_fb_addr_0_16_fb_addr_1_10_fb_addr_2_04_ETC___d1090[11:6])
      6'd0: valid__h101640 = rg_valid_0;
      6'd1: valid__h101640 = rg_valid_1;
      6'd2: valid__h101640 = rg_valid_2;
      6'd3: valid__h101640 = rg_valid_3;
      6'd4: valid__h101640 = rg_valid_4;
      6'd5: valid__h101640 = rg_valid_5;
      6'd6: valid__h101640 = rg_valid_6;
      6'd7: valid__h101640 = rg_valid_7;
      6'd8: valid__h101640 = rg_valid_8;
      6'd9: valid__h101640 = rg_valid_9;
      6'd10: valid__h101640 = rg_valid_10;
      6'd11: valid__h101640 = rg_valid_11;
      6'd12: valid__h101640 = rg_valid_12;
      6'd13: valid__h101640 = rg_valid_13;
      6'd14: valid__h101640 = rg_valid_14;
      6'd15: valid__h101640 = rg_valid_15;
      6'd16: valid__h101640 = rg_valid_16;
      6'd17: valid__h101640 = rg_valid_17;
      6'd18: valid__h101640 = rg_valid_18;
      6'd19: valid__h101640 = rg_valid_19;
      6'd20: valid__h101640 = rg_valid_20;
      6'd21: valid__h101640 = rg_valid_21;
      6'd22: valid__h101640 = rg_valid_22;
      6'd23: valid__h101640 = rg_valid_23;
      6'd24: valid__h101640 = rg_valid_24;
      6'd25: valid__h101640 = rg_valid_25;
      6'd26: valid__h101640 = rg_valid_26;
      6'd27: valid__h101640 = rg_valid_27;
      6'd28: valid__h101640 = rg_valid_28;
      6'd29: valid__h101640 = rg_valid_29;
      6'd30: valid__h101640 = rg_valid_30;
      6'd31: valid__h101640 = rg_valid_31;
      6'd32: valid__h101640 = rg_valid_32;
      6'd33: valid__h101640 = rg_valid_33;
      6'd34: valid__h101640 = rg_valid_34;
      6'd35: valid__h101640 = rg_valid_35;
      6'd36: valid__h101640 = rg_valid_36;
      6'd37: valid__h101640 = rg_valid_37;
      6'd38: valid__h101640 = rg_valid_38;
      6'd39: valid__h101640 = rg_valid_39;
      6'd40: valid__h101640 = rg_valid_40;
      6'd41: valid__h101640 = rg_valid_41;
      6'd42: valid__h101640 = rg_valid_42;
      6'd43: valid__h101640 = rg_valid_43;
      6'd44: valid__h101640 = rg_valid_44;
      6'd45: valid__h101640 = rg_valid_45;
      6'd46: valid__h101640 = rg_valid_46;
      6'd47: valid__h101640 = rg_valid_47;
      6'd48: valid__h101640 = rg_valid_48;
      6'd49: valid__h101640 = rg_valid_49;
      6'd50: valid__h101640 = rg_valid_50;
      6'd51: valid__h101640 = rg_valid_51;
      6'd52: valid__h101640 = rg_valid_52;
      6'd53: valid__h101640 = rg_valid_53;
      6'd54: valid__h101640 = rg_valid_54;
      6'd55: valid__h101640 = rg_valid_55;
      6'd56: valid__h101640 = rg_valid_56;
      6'd57: valid__h101640 = rg_valid_57;
      6'd58: valid__h101640 = rg_valid_58;
      6'd59: valid__h101640 = rg_valid_59;
      6'd60: valid__h101640 = rg_valid_60;
      6'd61: valid__h101640 = rg_valid_61;
      6'd62: valid__h101640 = rg_valid_62;
      6'd63: valid__h101640 = rg_valid_63;
    endcase
  end
  always@(rg_fbwriteback or
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (SEL_ARR_NOT_fb_err_0_75_112_NOT_fb_err_1_74_11_ETC___d1117 &&
	   ...
	   fb_valid_1 &&
	   fb_valid_2 ||
	   x__h101564 == 16'd65535 && !rg_replaylatest &&
	   !NOT_ff_core_request_notEmpty__082_083_OR_NOT_w_ETC___d1095 &&
	   !rg_fence_stall &&
	   fb_valid_3 &&
	   fb_valid_1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_release_from_FB && WILL_FIRE_RL_request_to_memory &&
	  (rg_fbwriteback == 2'd0 ||
	   x__h101564 == 16'd65535 && rg_fbwriteback == 2'd0 &&
	   !rg_replaylatest &&
	   !fb_valid_0_9_AND_fb_valid_1_0_AND_fb_valid_2_1_ETC___d25 &&
	   !rg_fence_stall &&
	   SEL_ARR_fb_valid_0_9_fb_valid_1_0_fb_valid_2_1_ETC___d1106 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_release_from_FB && WILL_FIRE_RL_request_to_memory &&
	  (rg_fbwriteback == 2'd1 ||
	   x__h101564 == 16'd65535 && rg_fbwriteback == 2'd1 &&
	   !rg_replaylatest &&
	   !fb_valid_0_9_AND_fb_valid_1_0_AND_fb_valid_2_1_ETC___d25 &&
	   !rg_fence_stall &&
	   SEL_ARR_fb_valid_0_9_fb_valid_1_0_fb_valid_2_1_ETC___d1106 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_release_from_FB && WILL_FIRE_RL_request_to_memory &&
	  (rg_fbwriteback == 2'd2 ||
	   x__h101564 == 16'd65535 && rg_fbwriteback == 2'd2 &&
	   !rg_replaylatest &&
	   !fb_valid_0_9_AND_fb_valid_1_0_AND_fb_valid_2_1_ETC___d25 &&
	   !rg_fence_stall &&
	   SEL_ARR_fb_valid_0_9_fb_valid_1_0_fb_valid_2_1_ETC___d1106 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_release_from_FB && WILL_FIRE_RL_request_to_memory &&
	  (rg_fbwriteback == 2'd3 ||
	   x__h101564 == 16'd65535 && rg_fbwriteback == 2'd3 &&
	   !rg_replaylatest &&
	   !fb_valid_0_9_AND_fb_valid_1_0_AND_fb_valid_2_1_ETC___d25 &&
	   !rg_fence_stall &&
	   SEL_ARR_fb_valid_0_9_fb_valid_1_0_fb_valid_2_1_ETC___d1106 &&
