...
//
// On Tue Jun 16 00:01:12 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkjtagdtm(CLK,
  ...
  wire [39 : 0] x1__h4478, x1__h4904, x1__h5462;
  wire [33 : 0] x__h4887;
  wire [31 : 0] x__h3817, x__h3831, x__h5954;
  wire [27 : 0] r1__read__h3878;
  wire [21 : 0] r1__read__h3890;
  wire [19 : 0] r1__read__h3902;
  wire [16 : 0] r1__read__h3914;
  wire [15 : 0] r1__read__h3926;
  wire [14 : 0] r1__read__h3938;
  wire [4 : 0] x__h5759;
  wire [3 : 0] IF_wr_tms_whas__1_AND_wr_tms_wget__3_7_THEN_2__ETC___d114;
  wire [1 : 0] spliced_bits__h4970;
  ...
  FIFO1 #(.width(32'd40), .guarded(32'd0)) request_to_DM(.RST(RST_N),
							 .CLK(CLK),
  ...
  FIFO1 #(.width(32'd34), .guarded(32'd0)) response_from_DM(.RST(RST_N),
							    .CLK(CLK),
  ...
  assign MUX_response_status_write_1__VAL_2 =
	     response_from_DM_EMPTY_N ? spliced_bits__h4970 : 2'd3 ;
  ...
  assign dmiaccess_shiftreg_EN_port0__write =
	     ...
	     (tapstate == 4'd0 ||
	      tapstate_EQ_3_7_AND_crossed_instruction_wget___ETC___d202) ;
  always@(tapstate or x1__h5462 or x1__h4904 or x1__h4478)
  begin
    case (tapstate)
      4'd0: dmiaccess_shiftreg_port0__write_1 = 40'd0;
      4'd3: dmiaccess_shiftreg_port0__write_1 = x1__h4904;
      4'd4: dmiaccess_shiftreg_port0__write_1 = x1__h4478;
      default: dmiaccess_shiftreg_port0__write_1 = x1__h5462;
    endcase
  end
  ...
  // register dmistat
  assign dmistat_D_IN = spliced_bits__h4970 ;
  assign dmistat_EN =
  ...
  // register dtmcontrol_shiftreg
  assign dtmcontrol_shiftreg_D_IN = (tapstate == 4'd3) ? x__h3817 : x__h3831 ;
  assign dtmcontrol_shiftreg_EN =
	     (tapstate == 4'd3 || tapstate == 4'd4) && instruction == 5'h10 ;

  // register idcode_sr
  always@(tapstate or x__h5954)
  begin
    case (tapstate)
      4'd0, 4'd3: idcode_sr_D_IN = 32'h100039D3;
      default: idcode_sr_D_IN = x__h5954;
    endcase
  end
  assign idcode_sr_EN =
	     tapstate == 4'd0 ||
  ...
  assign instruction_shiftreg_D_IN =
	     (tapstate == 4'd10) ? 5'b10101 : x__h5759 ;
  ...
  // register rg_dmireset
  assign rg_dmireset_D_IN = rg_dmireset_1_whas && x__h977 ;
  ...
  assign crossed_instruction_wget__51_EQ_0x11_85_AND_re_ETC___d198 =
	     ...
	     !capture_repsonse_from_dm ;
  assign r1__read__h3878 = { r1__read__h3890, 6'd6 } ;
  assign r1__read__h3890 = { r1__read__h3902, dmistat } ;
  assign r1__read__h3902 = { r1__read__h3914, 3'd7 } ;
  assign r1__read__h3914 = { r1__read__h3926, 1'd0 } ;
  assign r1__read__h3926 = { r1__read__h3938, rg_dmireset } ;
  assign r1__read__h3938 = { 14'd0, rg_dmihardreset } ;
  assign spliced_bits__h4970 = response_from_DM_D_OUT[1:0] | response_status ;
  ...
  assign x1__h4478 = { tdi_i_tdi, dmiaccess_shiftreg[39:1] } ;
  assign x1__h4904 = { dmiaccess_shiftreg[39:34], x__h4887 } ;
  assign x1__h5462 = { dmiaccess_shiftreg[39:2], 2'd3 } ;
  assign x__h3817 = { r1__read__h3878, 4'd1 } ;
  assign x__h3831 = { tdi_i_tdi, dtmcontrol_shiftreg[31:1] } ;
  assign x__h4887 = { response_from_DM_D_OUT[33:2], spliced_bits__h4970 } ;
  assign x__h5759 = { tdi_i_tdi, instruction_shiftreg[4:1] } ;
  assign x__h5954 = { tdi_i_tdi, idcode_sr[31:1] } ;
  assign x__h977 = tapstate != 4'd0 && dtmcontrol_shiftreg[16] ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  instruction == 5'h11 &&
	  response_from_DM_i_notEmpty__86_AND_TASK_testp_ETC___d239)
	$write("\tDTM: New DMIACCESS value: %h", x__h4887);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_shift_dmiaccess && tapstate == 4'd3 &&
	  instruction == 5'h11 &&
	  response_from_DM_i_notEmpty__86_AND_TASK_testp_ETC___d239)
