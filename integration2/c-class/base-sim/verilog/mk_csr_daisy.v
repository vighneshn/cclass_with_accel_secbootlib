...
//
// On Tue Jun 16 00:03:09 IST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_daisy(CLK,
  ...
  reg [1 : 0] CASE_mk_grp1mv_csrs_to_decode_BITS_198_TO_197_ETC__q1,
	      CASE_mk_grp1mv_mpp_1_mk_grp1mv_mpp_3_mk_grp1_ETC__q2,
	      CASE_mk_grp3mav_upd_on_debugger_BITS_65_TO_64_ETC__q3;
  wire [63 : 0] anydata__h1217,
		x__h3160,
		x__h3162,
		x__h3164,
		x__h3166,
  ...
  wire [15 : 0] x__h3610;
  wire [11 : 0] x__h3570;
  wire IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d126,
       mav_upd_on_trap_c_ULE_53___d103,
       mav_upd_on_trap_c_ULT_49___d101,
       mk_grp1_mv_core_resp__6_BIT_64_7_OR_mk_grp2_mv_ETC___d75,
       mk_grp1_mv_medeleg__20_SRL_mav_upd_on_trap_c_B_ETC___d124,
       mk_grp1_mv_mideleg__14_SRL_mav_upd_on_trap_c_B_ETC___d119,
       y__h3607;
  ...
  assign mv_csrs_to_decode =
	     { CASE_mk_grp1mv_csrs_to_decode_BITS_198_TO_197_ETC__q1,
	       mk_grp1_mv_csrs_to_decode[196:0] } ;
  ...
  assign MUX_rg_prv_write_1__VAL_2 =
		 ...
		 mav_upd_on_trap_c_ULE_53___d103) ?
		  ...
		  CASE_mk_grp3mav_upd_on_debugger_BITS_65_TO_64_ETC__q3) :
	       (((mk_grp1_mv_mideleg__14_SRL_mav_upd_on_trap_c_B_ETC___d119 ||
		  mk_grp1_mv_medeleg__20_SRL_mav_upd_on_trap_c_B_ETC___d124) &&
		 IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d126 &&
  ...
  // remaining internal signals
  assign IF_rg_prv_EQ_3_OR_rg_prv_EQ_1_THEN_rg_prv_ELSE_ETC___d126 =
	     mv_curr_priv <= 2'd1 ;
  assign anydata__h1217 = x__h3160 | mk_grp7_mv_core_resp[63:0] ;
  assign mav_upd_on_trap_c_ULE_53___d103 = mav_upd_on_trap_c <= 6'd53 ;
  assign mav_upd_on_trap_c_ULT_49___d101 = mav_upd_on_trap_c < 6'd49 ;
  assign mk_grp1_mv_core_resp__6_BIT_64_7_OR_mk_grp2_mv_ETC___d75 =
  ...
  assign mk_grp1_mv_medeleg__20_SRL_mav_upd_on_trap_c_B_ETC___d124 =
	     x__h3610[0] & y__h3607 ;
  assign mk_grp1_mv_mideleg__14_SRL_mav_upd_on_trap_c_B_ETC___d119 =
	     x__h3570[0] & mav_upd_on_trap_c[5] ;
  assign x__h3160 = x__h3162 | mk_grp6_mv_core_resp[63:0] ;
  assign x__h3162 = x__h3164 | mk_grp5_mv_core_resp[63:0] ;
  assign x__h3164 = x__h3166 | mk_grp4_mv_core_resp[63:0] ;
  assign x__h3166 = x__h3168 | mk_grp3_mv_core_resp[63:0] ;
  assign x__h3168 = mk_grp1_mv_core_resp[63:0] | mk_grp2_mv_core_resp[63:0] ;
  assign x__h3570 = mk_grp1_mv_mideleg >> mav_upd_on_trap_c[4:0] ;
  assign x__h3610 = mk_grp1_mv_medeleg >> mav_upd_on_trap_c[4:0] ;
  assign y__h3607 = ~mav_upd_on_trap_c[5] ;
  always@(mk_grp1_mv_csrs_to_decode)
  begin
    case (mk_grp1_mv_csrs_to_decode[198:197])
      2'd1, 2'd3:
	  CASE_mk_grp1mv_csrs_to_decode_BITS_198_TO_197_ETC__q1 =
	      mk_grp1_mv_csrs_to_decode[198:197];
      default: CASE_mk_grp1mv_csrs_to_decode_BITS_198_TO_197_ETC__q1 = 2'd0;
    endcase
  end
  ...
  always@(mk_grp3_mav_upd_on_debugger)
  begin
    case (mk_grp3_mav_upd_on_debugger[65:64])
      2'd1, 2'd3:
	  CASE_mk_grp3mav_upd_on_debugger_BITS_65_TO_64_ETC__q3 =
	      mk_grp3_mav_upd_on_debugger[65:64];
      default: CASE_mk_grp3mav_upd_on_debugger_BITS_65_TO_64_ETC__q3 = 2'd0;
    endcase
  end
